...
{
  $column['US_post_views_count'] = __('Visualizações', 'upsites');
  return $column;
}
add_filter('manage_post_posts_columns', 'US_post_views_count');
...
add_action('manage_post_posts_custom_column',  'views_count_show_columns');
